...
#define	BY2PTE		BY2WD			/* bytes per pte entry: sizeof(PTE) */
#define	XPGSHIFT	22				/* log2(BY2XPG) */
#define	NPDPTE		1
...
#define	CPU0PTE		(KZERO+0x13000)		/* bootstrap processor PTE's for 0-8MB (2 pages) */
