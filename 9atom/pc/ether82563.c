/*
 * Intel 8256[367], 8257[1-9], 8258[03], i21[01789], i350, i354
...
static Ctlrtype cttab[Nctlrtype] = {
	...
	i218,		9728,	1,	"i218",		F79phy|Fnofct|Fload|Fert,
	i219,		9728,	1,	"i219",		F79phy|Fnofct|Fload|Fert,
	i350,		9728,	1,	"i350",		F75|F79phy|Fnofct,
	i354,		9728,	1,	"i350",		F75|F79phy|Fnofct,
};
...
i82563multicast(void *arg, uchar *addr, int on)
{
	...
	if(ctlr->type == i82566)
		x &= 31;
	if(ctlr->type == i210 || ctlr->type == i217 || ctlr->type == i218)
		x &= 15;
...
didtype(int d)
{
	...
	case 0x1524:		/* sgmii */
		return i350;
	case 0x1f40:		/* backplane */
	case 0x1f41:		/* sgmii */
	case 0x1f42:		/* sgmii (c2000) */
	case 0x1f45:		/* backplane 2.5 */
		return i354;
	}
	return -1;
}
