...
extern	int	digitrunevalue(Rune);

extern	int	runecompose(Rune, Rune);
extern	int	runedecompose(Rune, Rune*);
extern	Rune*	runeclass(Rune);
...
extern	int	bintime(int, vlong*, vlong*, vlong*);
