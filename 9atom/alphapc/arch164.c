...
void
outs2117x(int port, u16int val)
{
	mb();
	*(u16int*)(iobase(port)) = val;
	mb();
}

void
outl2117x(int port, u32int val)
{
	mb();
	*(u32int*)(iobase(port)) = val;
	mb();
}
