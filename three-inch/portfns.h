...
Chan*		newchan(void);
void		newcons(void *, int, void (*)(void*, char*, int), int (*)(void*));
int		newfd(Chan*);
Mhead*		newmhead(Chan*);
Mount*		newmount(Mhead*, Chan*, int, char*);
Page*		newpage(int, Segment **, ulong, uint);
Path*		newpath(char*);
Pgrp*		newpgrp(void);
Rgrp*		newrgrp(void);
Proc*		newproc(void);
...
void		pagechaintail(Page*);
void		pageinit(void);
uint	pagenumber(Page*);
...
void		physallocrange(usize*, usize*);
void		physdump(void);
void		physfree(uintmem, usize);
void		physinit(uintmem);
void		physinitfree(uintmem, uintmem);
void		pio(Segment *, ulong, ulong, Page **);
#define		poperror()		(void)5;
...
void		putimage(Image*);
void		putmhead(Mhead*);
void		putmmu(uintptr, uintmem, Page*);
void		putpage(Page*);
void		putseg(Segment*);
...
long		seconds(void);
uintptr		segattach(Proc*, ulong, char *, uintptr, usize);
void		segclock(ulong);
